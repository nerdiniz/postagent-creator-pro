...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside className={`
        fixed inset-y-0 left-0 bg-white dark:bg-card-dark border-r border-slate-200 dark:border-border-dark flex flex-col z-40 transition-all duration-300 ease-in-out
      ...
      `}>
        ...
        <div className="p-6 flex items-center justify-between">
          <div className={`flex items-center gap-3 overflow-hidden ${isCollapsed ? 'lg:opacity-0 lg:w-0' : 'opacity-100'}`}>
